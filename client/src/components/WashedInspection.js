  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const inspectionData = {
        ...
        shrinkagePercentage: parseFloat(formData.shrinkagePercentage) || 0,
      ...
      <MobileContainer maxWidth="md">
        <HeaderPaper elevation={3}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', mb: 2 }}>
            ...
            <LocalLaundryService sx={{ fontSize: { xs: 30, sm: 40 }, mr: 1 }} />
            <Typography 
          ...
          <Typography 
            ...
            sx={{ opacity: 0.9 }}
          >
            Post-wash fabric quality inspection
          </Typography>
        </HeaderPaper>
          ...
          <StyledCard elevation={2}>
            <CardContent>
              ...
              <CalculationBox>
                ...
                <Typography variant="h4" sx={{ color: '#2e7d32' }} fontWeight="bold" textAlign="center">
              ...
              <Grid container spacing={2}>
                <Grid item xs={12}>
                  <TextField
                    ...
                    size={isMobile ? "medium" : "medium"}
                    variant="outlined"
                    placeholder="Describe post-wash defects (color bleeding, shrinkage issues, fabric damage, etc.)"
                  />
                </Grid>
                <Grid item xs={12}>
                  <TextField
                    ...
                    size={isMobile ? "medium" : "medium"}
                    variant="outlined"
                    placeholder="e.g., Color Bleeding, Pilling, Shrinkage, Texture Change"
                  />
                </Grid>
                <Grid item xs={12}>
                  <TextField
                    ...
                    size={isMobile ? "medium" : "medium"}
                    variant="outlined"
                    placeholder="Additional observations or post-wash recommendations"
                  />
                </Grid>
              </Grid>
            </CardContent>
